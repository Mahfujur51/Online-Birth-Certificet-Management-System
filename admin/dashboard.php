                    ...
                    <div class="income-dashone-total income-monthly shadow-reset nt-mg-b-30">
                        ...
                        <div class="income-dashone-pro">
                            <div class="income-rate-total">
                                ...
                                $sql="SELECT * FROM tbl_application WHERE status=''";
                                $query=mysqli_query($con,$sql);
                                $num1=mysqli_num_rows($query);
                                ?>
                                <div class="price-adminpro-rate">
                                    <h3><span class="counter"><?php echo $num1; ?></span></h3>
                                </div>
                 ...
                 <div class="income-dashone-total orders-monthly shadow-reset nt-mg-b-30">
                    ...
                    <div class="income-dashone-pro">
                        <div class="income-rate-total">
                           ...
                           $sql2="SELECT * FROM tbl_application WHERE status='Verified'";
                           $query2=mysqli_query($con,$sql2);
                           $num2=mysqli_num_rows($query2);
                           ?>
                           <div class="price-adminpro-rate">
                            <h3><span class="counter"><?php echo $num2; ?></span></h3>
                        </div>
                        <div class="price-graph">
            ...
            <div class="income-dashone-pro">
                <div class="income-rate-total">
                     <?php 
                           ...
                           $sql3="SELECT * FROM tbl_application WHERE status='Rejected'";
                           $query3=mysqli_query($con,$sql3);
                           $num3=mysqli_num_rows($query3);
                           ?>
                    <div class="price-adminpro-rate">
                        <h3><span class="counter"><?php echo $num3;?></span></h3>
                    </div>
                    <div class="price-graph">
