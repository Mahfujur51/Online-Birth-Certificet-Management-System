...
if (strlen($_SESSION['obcsuid']==0)) {
  header('location:logout.php');
    ...
    if(isset($_POST['submit']))
    {
        ...
        $sql="UPDATE tbl_user SET fname='$fname',lname='$lname',address='$address' WHERE id='$id'";
                                            ...
                                            <form method="post" action="">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control" name="fname" value="<?php echo $result['fname'];?>" required="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control" name="lname" value="<?php  echo $result['lname'];?>" required="true" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control" readonly="true" value="<?php echo $result['mobile'];?>" />
                                                        </div>
                                                    </div>
                                                </div>
                                                <div class="form-group-inner">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                            <input type="text" class="form-control" readonly="true" value="<?php  echo $result['date'];?>" />
                                                        </div>
                                                    </div>
                                                </div>
