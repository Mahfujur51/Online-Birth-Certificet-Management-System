...
if(isset($_POST['submit']))
{
    ...
    if ($num>0) {
        $fsql="UPDATE tbl_user SET password='$newpassword' WHERE mobile='$mobile'";
        $fquery=mysqli_query($con,$fsql);
        if ($fquery) {
            echo "<script>alert('Your Password succesfully changed');</script>";
        }else{
            echo "<script>alert('Something Worng Please try Again!!');</script>";
        }
    }else{
                        ...
                        <div class="col-lg-4">
                            <div class="login-bg">
                                <div class="row">
                                    <div class="col-lg-12">
                                        <div class="logo">
                                            <h3 style="font-weight: bold;color: blue">Online Birth</h3>
                                        </div>
                                    </div>
                                </div>
                                <div class="row">
