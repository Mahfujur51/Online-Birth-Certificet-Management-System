...
if (strlen($_SESSION['obcsuid']==0)) {
  header('location:logout.php');
    ...
    if(isset($_POST['submit']))
    {
        ...
        if ($num>0) {
            $usql="UPDATE tbl_user SET password='$newpassword' WHERE id='$id'";
            $upquery=mysqli_query($con,$usql);
            if ($upquery) {
                ...
                echo "<script>window.location.href ='change-password.php'</script>";
                         ...
                         echo '<script>alert("Your current password can not Change!!")</script>';
                                            ...
                                            <form method="post" onsubmit="return checkpass();" name="changepassword" method="post">
                                                ...
                                                <div class="form-group-inner">
                                                    <div class="row">
                                                        ...
                                                        <div class="col-lg-9">
                                                           <input type="password" class="form-control" name="password" id="currentpassword"required='true'>
                                                       </div>
                                                   </div>
                                               </div>
                                               <div class="form-group-inner">
