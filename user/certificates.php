                        ...
                        <div class="sparkline13-graph">
                            <div id="exampl">
                                <div class="datatable-dashv1-list custom-datatable-overright">
                                    ...
                                    <?php
                                    $id=$_GET['viewid'];
                                    $sql="SELECT * FROM tbl_application JOIN tbl_user on tbl_application.userid=tbl_user.id WHERE tbl_application.id='$id' AND status='Verified'";
                                    ...
                                    <table border="1" class="table table-bordered">
                                        <tr align="center">
                                            <td colspan="4" >
                                            <strong> Application Number:</strong>   <?php  echo $result['applicationid'];?></td></tr>
                                    ...
                                    <p align="left"><b>Certificate Genration Date :</b> <?php echo htmlentities($result['date']);?></p>
                                    <?php
                                    }
                                    }
                                    ?>
